...
\lstdefinelanguage
   ...
   {
    deletekeywords={mov,inc,org, end, nop, jmp, jnb, jnc, pop, jz, push, ret, jb, jnz, setb, add, mul, jc},
    morekeywords={[3]a,b,r0,r1,r2,r3,r4,r5,r6,r7,\$,c,dptr, @dptr, @a, 00, acc, ab, p1, p2, p3 ,p4, p5, p6 ,p7 , p8, p9, dpl, dph},
    morekeywords={[2]subb, clr, ljmp, movx,end,mov,inc, nop, jmp, end, orl, jnb, jnc, djnz, sjmp, pop, acall, jz, push, ret, jb, jnz, anl, cpl, setb, add, mul, movc,jc}   
    }
