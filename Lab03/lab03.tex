...
Przygotować program umożliwiający wybór i przypisanie do klawiszy klawiatury - guzików od 0 do 9, A, B, C
    - jednego z trzech zestawów znaków, które będą wypisywane na wyświetlaczu LCD gdy klawisze klawiatury
    będą naciskane. Przełączenie zestawów: guzik * - małe litery od a do m, guzik \# - duże litery do A do M,
    guzik D - cyfry od 0 do 9 oraz znaki A, B, C.
